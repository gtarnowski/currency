(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('date-fns/add_days'), require('date-fns/is_before'), require('date-fns/is_today'), require('date-fns/start_of_day'), require('date-fns/difference_in_calendar_months'), require('preact')) :
  typeof define === 'function' && define.amd ? define(['date-fns/add_days', 'date-fns/is_before', 'date-fns/is_today', 'date-fns/start_of_day', 'date-fns/difference_in_calendar_months', 'preact'], factory) :
  (global.Dayzed = factory(global.dateFns.addDays,global.dateFns.isBefore,global.dateFns.isToday,global.dateFns.startOfDay,global.dateFns.differenceInCalendarMonths,global.preact));
}(this, (function (addDays,isBefore,isToday,startOfDay,differenceInCalendarMonths,React) { 'use strict';
